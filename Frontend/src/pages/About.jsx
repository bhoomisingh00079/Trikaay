        ...
        <section className="mx-auto w-full max-w-6xl px-5 py-14">
          ...
          <section className="mt-10 rounded-xl bg-[#efefef] px-4 py-12">
            ...
            <div className="mx-auto grid max-w-3xl gap-4 md:hidden">
              <div className="mx-auto flex h-44 w-44 items-center justify-center rounded-full border border-[#5a2a7a] bg-[#8b5aa8] p-5 text-center text-white shadow">
              ...
              <div className="grid grid-cols-2 gap-4 max-sm:grid-cols-1">
                {objectiveItems.map((item) => (
                  <div
                    key={item.title}
                    className="flex min-h-[150px] flex-col items-center justify-center rounded-[2rem] border-2 border-[#2a1d33] bg-[#8b5aa8] p-4 text-center text-white shadow"
                  >
